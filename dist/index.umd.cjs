...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("@react-three/fiber"), require("camera-controls"), require("hold-event"), require("react"), require("three"), require("graphology"), require("zustand"), require("zustand/shallow"), require("three-stdlib"), require("graphology-metrics/centrality/degree.js"), require("d3-scale"), require("graphology-metrics/centrality/pagerank.js"), require("graphology-shortest-path"), require("@react-spring/three"), require("@react-three/drei"), require("@use-gesture/react"), require("ellipsize"), require("graphology-layout/circular.js"), require("graphology-layout/random.js"), require("graphology-layout-forceatlas2"), require("d3-force-3d"), require("d3-hierarchy"), require("graphology-layout-noverlap"), require("classnames")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "@react-three/fiber", "camera-controls", "hold-event", "react", "three", "graphology", "zustand", "zustand/shallow", "three-stdlib", "graphology-metrics/centrality/degree.js", "d3-scale", "graphology-metrics/centrality/pagerank.js", "graphology-shortest-path", "@react-spring/three", "@react-three/drei", "@use-gesture/react", "ellipsize", "graphology-layout/circular.js", "graphology-layout/random.js", "graphology-layout-forceatlas2", "d3-force-3d", "d3-hierarchy", "graphology-layout-noverlap", "classnames"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.reagraph = {}, global.jsxRuntime, global.fiber, global.ThreeCameraControls, global.holdEvent, global.React, global.three, global.Graph, global.zustand, global.shallow, global.threeStdlib, global.degree_js, global.d3Scale, global.pagerank, global.graphologyShortestPath, global.three$1, global.drei, global.react, global.ellipsize, global.circular, global.random, global.forceAtlas2Layout, global.d3Force3d, global.d3Hierarchy, global.noverlapLayout, global.classNames));
})(this, (function(exports2, jsxRuntime, fiber, ThreeCameraControls, holdEvent, React, three, Graph, zustand, shallow, threeStdlib, degree_js, d3Scale, pagerank, graphologyShortestPath, three$1, drei, react, ellipsize, circular, random, forceAtlas2Layout, d3Force3d, d3Hierarchy, noverlapLayout, classNames) {
  "use strict";
  ...
  const Label = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(drei.Billboard, { children: backgroundColor ? /* @__PURE__ */ jsxRuntime.jsx("mesh", { children: /* @__PURE__ */ jsxRuntime.jsxs(
      drei.RoundedBox,
      {
...
`;
  ...
  const Badge = ({
    ...
    const normalizedFontWeight = React.useMemo(() => {
    ...
    const textSizeCalculations = React.useMemo(() => {
    ...
    const contentLayout = React.useMemo(() => {
      if (!icon) {
        return {
          textX: 0,
          textY: 0,
  ...
  function forceInABox() {
    ...
    function initializeWithTreemap() {
      const sim = d3Hierarchy.treemap().size(force.size());
  ...
  exports2.clearMeasurementCache = clearMeasurementCache;
  ...
  exports2.getMeasurementCacheSize = getMeasurementCacheSize;
